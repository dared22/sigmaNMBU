          ...
          <div className="relative grid gap-8 px-6 py-16 lg:grid-cols-12 lg:gap-12 lg:px-10 lg:py-20">
            <div className="flex flex-col justify-center lg:col-span-7">
              ...
              <ScrollReveal delay={0.06}>
                <h1 className="mt-4 font-headline text-4xl font-bold tracking-tight text-on-surface md:text-6xl lg:text-7xl">
              ...
              <ScrollReveal delay={0.12}>
                <p className="mt-6 max-w-2xl font-body text-lg leading-relaxed text-on-surface/90">
                  {t("hero.body")}
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.18}>
                <div className="mt-8 flex flex-wrap gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className={buttonClassName("primary", "px-8 py-4")}
                  >
                    <span
                  ...
                  <Link
                    href="/om-oss"
                    className={buttonClassName("ghost", "px-8 py-4")}
                  >
